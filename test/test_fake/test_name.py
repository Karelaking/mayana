...
names_data = {
    'USA': {
        'first_names': ['John', 'Michael', 'Jessica', 'Emily', 'Robert', 'Ashley', 'William', 'David', 'Sarah', 'Daniel'],
    ...
    'UK': {
        'first_names': ['Oliver', 'Harry', 'George', 'Emma', 'Olivia', 'Sophia', 'Jack', 'Charlie', 'Amelia', 'Isabella'],
    ...
    'Canada': {
        ...
        'last_names': ['Smith', 'Brown', 'Tremblay', 'Martin', 'Roy', 'Wilson', 'MacDonald', 'Gagnon', 'White', 'Taylor']
    },
    'Australia': {
    ...
    'Germany': {
        ...
        'middle_names': ['Karl', 'Friedrich', 'Anna', 'Maria', 'Johann', 'Elisabeth', 'Heinrich', 'Clara', 'Peter', 'Luise'],
    ...
    'Korea': {
        'first_names': ['Ji-ho', 'Seo-jun', 'Ha-joon', 'Ji-woo', 'Ji-yoon', 'Seo-yeon', 'Min-jun', 'Joo-won', 'Hyun-woo', 'Yu-jin'],
    ...
    'Italy': {
        'first_names': ['Luca', 'Matteo', 'Giulia', 'Sofia', 'Marco', 'Francesca', 'Davide', 'Chiara', 'Riccardo', 'Martina'],
        'middle_names': ['Maria', 'Giovanni', 'Luigi', 'Angela', 'Antonio', 'Elena', 'Paolo', 'Silvia', 'Franco', 'Roberta'],
    ...
    'Thailand': {
        ...
        'last_names': ['Somsak', 'Saetang', 'Pongchai', 'Khamdee', 'Phasuk', 'Siriwat', 'Kanjan', 'Namsai', 'Chaiprasit', 'Saelim']
    },
    'Philippines': {
        'first_names': ['Jose', 'Maria', 'Juan', 'Rizal', 'Angel', 'David', 'Rose', 'Luis', 'Grace', 'Mark'],
        'middle_names': ['Santos', 'Reyes', 'Cruz', 'Dela', 'Garcia', 'Lopez', 'Martinez', 'Perez', 'Ramos', 'Gonzalez'],
        'last_names': ['Santos', 'Reyes', 'Cruz', 'Bautista', 'Garcia', 'Lopez', 'Martinez', 'Perez', 'Ramos', 'Gonzalez']
    }
    # Add more countries as needed
}

def generate_random_name(country, is_middle_name=False):
    first_names = names_data[country]['middle_names' if is_middle_name else 'first_names']
